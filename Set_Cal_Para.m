...
try 
set_model = para{1};set_fit = para{2};set_waveformat = para{3};                                                       
set_rpttype = para{4}; set_wavetype = para{5};set_delay = para{6};set_fftnum = para{7};
set_density = para{8};set_velocity = para{9};set_radiation = para{10};
catch ErrorInfo
...
tree.data.waveform = set_waveformat;tree.data.reportform = set_rpttype;
