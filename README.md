...
- 特别感谢**郑建常研究员**提供的原始计算程序脚本和技术指导。感谢黑龙江地震局**周晨**、辽宁省地震局**夏彩韵**、山东地震局**崔华伟**、**刘承雨**、**王书豪**、**李国一**等对程序的调试工作、山东局**李翠芹**对大量震例进行了测试，及使用过程中提出的改进意见，感谢山东局**李铂**提供的测试数据。本程序是在中国地震局震情跟踪面上项目和青年项目的共同资助下完成。
